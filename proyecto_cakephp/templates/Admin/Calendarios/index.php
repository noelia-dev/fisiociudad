 ...
 <div class="container-fluid mt-5">
     ...
     <div class="row">
         ...
         <div class="col text-right">
             ...
             <?= $this->Html->link('<i class="fas fa-trash"></i>Eliminar fecha', ['action' => 'delete'], ['class' => 'btn btn-danger', 'escape' => false]) ?>
         </div>
     </div>
     <!-- Page Heading -->
                                             ...
                                             <?php foreach ($weeks as $week => $days) {
                                                 ...
                                                 <tr class="table-row">
                                                     <?php foreach ($weekdays as $day) {
                                                         ...
                                                         <?php } else { ?>
                                                             <td id='btnSeleccionable' class="table-date active-date font-weight-bold seleccionable">
                                                                 <?php echo isset($days[$day]) ? $days[$day] : '&nbsp'; ?>
                                                             </td>
                                                     <?php }
                                                        } ?>
